// First-run welcome: a plain safety disclaimer (required, since this app guides people
    ...
    <div className="welcome-overlay">
      <div className="welcome-card">
        ...
        <div className="welcome-mission">
          ...
          wall: parking, the approach, the stuff that never made the guidebook. It
        ...
        <ul className="welcome-tips">
          ...
          <li><strong>Fix a location</strong> if a wall's pin is off, and help clean up the map.</li>
        </ul>
        ...
        {showInstall && (
          <div className="welcome-install">
            ...
            <p>
              ...
              ten seconds, and we'll walk you through it.
            </p>
